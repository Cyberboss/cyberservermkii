...
let
    ...
    rml-headless-tweaks-source = pkgs.fetchurl {
        url = "https://github.com/Cyberboss/HeadlessTweaks/releases/download/2.3.0-preview6/HeadlessTweaks.dll";
        sha256 = "sha256-fFzRcVQ3HKcAf6m45Uzvm4M0qw6Ohc7Bxi6JLQL11Aw=";
    };
