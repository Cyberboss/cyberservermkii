...
let
    ...
    rml-headless-tweaks-source = pkgs.fetchurl {
        url = "https://github.com/Cyberboss/HeadlessTweaks/releases/download/2.3.0-preview5/HeadlessTweaks.dll";
        sha256 = "sha256-YOG3dWH+bVeA5jsUqBlILTQMETIVujC1KWVNn2CSgbw=";
    };
